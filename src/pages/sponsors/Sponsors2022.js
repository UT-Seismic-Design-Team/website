...
export default class Sponsors2022 extends Component {
  render() {
    return (
      <div>
        <h1 className='text-center font-weight-bold text-info'>Gold Sponsors</h1>
        ...
        <h1 className="text-center font-weight-bold text-info">Silver Sponsors</h1>
        <Sponsor  image="EntuitiveU.png"
                  sponsor="Entuitive U"
                  des="Entuitive U provides students with a tangible experience in the life of a real engineer, through participation in several activities based on real Entuitive projects. It also gives students and recent graduates a meaningful connection to the industry by connecting them with subject matter experts."
