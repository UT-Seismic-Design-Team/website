...
export default class Sponsors2018 extends Component {
  ...
  render() {
    ...
    <div>
        ...
        <Sponsor image="CastConnex.png" sponsor="Cast Connex" des="CAST CONNEX® is the industry leader in the architectural and structural use of cast steel components in the design and construction of building and bridge structures. Our products include pre-engineered connectors that simplify the design and enhance the performance of structures. We also offer design-build services for custom cast steel nodes and components." link="http://www.castconnex.com/"/>
