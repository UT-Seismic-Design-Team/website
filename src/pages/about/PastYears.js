...
import PastYears2023 from "./pastyears/PastYears2023";
import PastYears2024 from "./pastyears/PastYears2024";
import $ from "jquery";
...
export default class newPastYears extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pastYearCollection: <PastYears2024 />,
    };
  ...
  onClick(e) {
    ...
    if (year === "2024") {
      ...
      this.setState({
        pastYearCollection: <PastYears2023 />,
      });
    } else if (year === "2022") {
      this.setState({
    ...
    return (
      <div>
        ...
        <Container fluid className="col-lg-10 body-content">
          <div className="big-font text-dark">Past Competitions</div>
          <br />
          <br />
          <div className="row">
            <div className="card mb-5">
              <div className="card-header">
                <ul className="nav nav-tabs card-header-tabs">
                  <li className="nav-item">
                    <button
                      id="2024"
                      className="nav-link active sponsor-tab"
                  ...
                  <li className="nav-item">
                    <button
                      id="2023"
                      className="nav-link non-active sponsor-tab"
                      onClick={this.onClick}
                    >
                      2023
                    </button>
              ...
              <div className="card-body">{this.state.pastYearCollection}</div>
            </div>
          </div>
        </Container>
        <Footer />
