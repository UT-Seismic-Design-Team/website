            ...
            <div className="row">
                <div className="col-md-8 text-center body-content">
                    ...
                    <p>
                        ...
                        They allow us to learn, teach and achieve incredible accomplishments. To learn more , email <u>ut.seismic@gmail.com</u>.
                        You can find all our amazing sponsors (past and present) <Link to="/sponsors">here</Link>
                    </p>
                    {/* <a className="btn btn-success" href="https://drive.google.com/file/d/13EeeSLytOPuJXVIyu_v7r02Ww1ECx1Dq/view?usp=sharing">Sponsorship Package</a> */}
                </div>
            </div>
