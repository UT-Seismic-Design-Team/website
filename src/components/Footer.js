    ...
    render() {
        return <footer className="footer" id="contact">
                    <div className="row pt-3">
                        ...
                        <div className="col-md">
                            <a href="https://www.facebook.com/UofTSeismic/" target="blank">
                                <i className="fa fa-facebook fa-lg mr-3 mt-3" style={{fontSize: '48px'}}/>
                            </a>
                            <a href="https://www.linkedin.com/company/43272649" target="blank">
                            ...
                            <a href="https://www.instagram.com/uoftseismic/" target="blank">
                                <i className="fa fa-instagram fa-lg mr-3 mt-3" style={{fontSize: '48px'}}/>
                            </a>
                        </div>
                    </div>
                </footer>;
