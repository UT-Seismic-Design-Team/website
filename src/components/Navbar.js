  ...
  render() {
    return <Navbar className="navbar" light expand="md">
      <NavLink tag={Link} to="/" style={{padding: 0}}>
        <img style={{
          height: '75px'
        }} src={require('../images/logo-transparent.png')} alt="logo"/>
      </NavLink>
          ...
          <NavItem>
            <Dropdown className="d-inline-block" toggle={this.aboutToggleDropdown} isOpen={this.state.aboutDropdownOpen}>
              ...
              <DropdownMenu>
                ...
                <DropdownItem tag={Link} to="/apply"> Applications </DropdownItem>
                <DropdownItem tag={Link} to="/design"> Our Design Process </DropdownItem>
              </DropdownMenu>
            </Dropdown>
          </NavItem>
          <NavItem>
            <NavLink tag={Link} to="/academy">Academy</NavLink>
          </NavItem>
          <NavItem>
